...
export type Section = "overview" | "orders" | "store" | "customers" | "forecasting" | "reports" | "settings";

const validSections: Section[] = ["overview", "orders", "store", "customers", "forecasting", "reports", "settings"];
